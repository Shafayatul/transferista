                ...
                <div class="row pt-5 mt-3">
                    <div class="col-md-12 mb-3">
                        <div class="intro-info-content text-center">
                            <h1 class="display-3 white-text mb-5 wow fadeInDown" data-wow-delay="0.3s">Terms & Conditions</h1>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="container">
                      ...
                      <!-- Section heading -->
                      <h2 class="h1-responsive font-weight-bold text-center my-5">Terms & Conditions</h2>
                      <hr/>
                      <!-- Section description -->
...
.page-wrapper{
  background-image: url('/../static/img/mobile-feature.jpg');
