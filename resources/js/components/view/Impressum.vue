                ...
                <div class="row pt-5 mt-3">
                    <div class="col-md-12 mb-3">
                        <div class="intro-info-content text-center">
                            <h1 class="display-3 white-text mb-5 wow fadeInDown" data-wow-delay="0.3s">Impressum</h1>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="container">
                      ...
                      <!-- Section heading -->
                      <h2 class="h1-responsive font-weight-bold text-center my-5">Impressum</h2>
                      <hr/>
                      <!-- Section description -->
                      <p class=" w-responsive mx-auto mb-5 grey-text">
                        Transferista - Mag. Bianca Lehrner<br>
                        Himmelpfortgasse 20<br>
                        1010 Wien<br>
                        Austria<br>
                        Tel: +43 1 944 57 43<br>
                        E-Mail: office@transferista.com<br>
                        Internet: www.transferista.com<br>
                        <br>
...
export default {
    data(){
      return {
          video: "https://player.vimeo.com/39970581/"
      } 
    },
    computed:{
    },
...
.page-wrapper{
  background-image: url('/../static/img/send-message.jpg');
