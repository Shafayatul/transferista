                ...
                <div class="row pt-5 mt-3">
                    <div class="col-md-12 mb-3">
                        <div class="intro-info-content text-center">
                            <h1 class="display-3 white-text mb-5 wow fadeInDown" data-wow-delay="0.3s">Services</h1>
                            ...
                            <div class="container">
                                <section class="text-center my-5 wow fadeIn" data-wow-delay="0.3s">
                                    ...
                                    <!-- Section description -->
                                     <!-- Posts grid -->
                                    <div class="row">
                                        <div class="col-sm-12 col-md-3 col-xl-3" v-for="content of postGridContent.data">   
                                            <div class="card border-0 border-rad m-0">
                                                <a :href="content.link"><img class="border-rad-top img-fluid w-100" :src="content.image_path" alt="Card image cap" width="370" height="253" /></a>
                                                <div class="card-body px-4 pt-4 border-rad-bottom">
                                                <h4 class="card-title mb-2"><a :href="content.link">{{content.title}}</a></h4>
...
<script>
console.clear()
 import postGridContent from '../data/posts.json'
